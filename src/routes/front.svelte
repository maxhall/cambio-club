  ...
  <defs>
    ...
    <filter id="displacementFilter">
      ...
      <feDisplacementMap in2="turbulence" in="SourceGraphic"
          scale="23" xChannelSelector="R" yChannelSelector="G"/>
    </filter>
  </defs>
  <!-- The translate here could be finessed	 -->
  <g style="filter: url(#displacementFilter)" transform="scale({innerWidth / 1182} {innerWidth / 1182}) translate(1 1)">
...
<style>
  ...
  .overlay {
    ...
    left: 0;
    margin: 0;
    filter: contrast(100%) brightness(70%) sepia(100%);
    background: url("data:image/svg+xml,%3Csvg viewBox='0 0 318 318' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='1' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)'/%3E%3C/svg%3E");
